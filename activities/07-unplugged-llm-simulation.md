...
mode: Unplugged
duration: "45 minutes"
assessment: "No (or, students then implement the same 'language model' in code)"
...
- Pre-printed training datasets
- One six-sided die for each group (can replace with random number generator)

## Assessment

No (or, students then implement the same 'language model' in code)
