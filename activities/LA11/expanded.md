<!-- DRAFT expanded version, 2026-09-12. Developed from the activity description in the WG11 report (section 6, LA11) using the working group's four existing expanded versions (LA02, LA03, LA08, LA14) as models, with GenAI assistance. Not yet reviewed by the activity author and not part of the report. Everything below the "Purpose" section that is not in the report description is a proposal for the author to accept, edit or delete. -->

> **Draft.** This expanded version has not yet been reviewed by the activity's author. The short description in [README.md](README.md) is the authoritative version from the working-group report.
