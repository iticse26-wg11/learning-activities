...
**Related ILOs** (at the end of the course, students should be able to …)   <!-- this block, up to the Type line, is regenerated by scripts/build-index.py -->
- [ID1](https://github.com/iticse26-wg11/intended-learning-outcomes/blob/main/ilos/ID1.md): statement
- [ID2](https://github.com/iticse26-wg11/intended-learning-outcomes/blob/main/ilos/ID2.md): statement
